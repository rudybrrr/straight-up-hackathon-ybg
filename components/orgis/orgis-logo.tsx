...
export function OrgisLogo({
  ...
  return (
    <div className="flex items-center gap-3 overflow-visible">
      <div
        className={cn(
          "flex shrink-0 flex-col justify-center gap-1 rounded-[1.35rem] bg-slate-950 shadow-soft",
      ...
      <div className="space-y-1">
        <div
          className={cn(
            "inline-block overflow-visible pr-2 leading-none tracking-[-0.06em]",
            compact ? "text-3xl font-black" : "text-4xl font-black sm:text-5xl"
          )}
        >
          <span className="text-slate-950">Org</span>
